    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-xs-12 col-sm-12">
                <div class="sv-video">
                    <video poster="assets/images/single-video.png" style="width:100%;height:100%;" controls="controls" width="100%" height="100%">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <label class="clipboard">
                                            <input type="text" name="#" value="http://youtu.be/DwGgdfe-C6c" readonly>
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        <h4>Start at:</h4>
            ...
            <div class="col-lg-4 col-xs-12 col-sm-12">
                ...
                <div class="caption playlist">
                    <div class="left">
                        <a href="#">Uncharted 4 Full Gameplay...</a>
                    </div>
                    <div class="right">
                ...
                <div class="list">
                    ...
                    <div class="h-video playlist row">
                        ...
                        <div class="col-lg-7 col-sm-7 col-xs-6">
                            <div class="v-desc">
                                <a href="single-video-tabs.html">Uncharted 4 A Thiefs End Walkthrough Part 2 ...</a>
                            </div>
                            <div class="v-views">
                                429,347 views
                            </div>
                    ...
                    <div class="h-video playlist row">
                        ...
                        <div class="col-lg-7 col-sm-7 col-xs-6">
                            <div class="v-desc">
                                <a href="single-video-tabs.html">Uncharted 4 A Thiefs End Walkthrough Part 3 ...</a>
                            </div>
                            <div class="v-views">
                                630,347 views
                            </div>
                    ...
                    <div class="h-video playlist row">
                        ...
                        <div class="col-lg-7 col-sm-7 col-xs-6">
                            <div class="v-desc">
                                <a href="single-video-tabs.html">Uncharted 4 A Thiefs End Walkthrough Part 4 ...</a>
                            </div>
                            <div class="v-views">
                                630,347 views
                            </div>
