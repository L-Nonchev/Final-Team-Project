	                ...
	                <div class="l-form">
	                    <form enctype='multipart/form-data' action="#" method="post" onsubmit="event.preventDefault();" id="imageUploadForm">
	                        ...
	                        <div class="form-group">
								...
								<label>File profil picture</label>
								<input type="file" name="picture"  id="uploadPic" accept="image/*" class="loader"/>
	                ...
	                <div class="l-form">
	                    <form enctype='multipart/form-data' action="#" method="post" onsubmit="event.preventDefault();">
	                        ...
	                        <div class="form-group">
								...
								<input type="file" name="banner" accept="image/*" class="loader"/>
							<!-- <label for=""><?= $error ?></label>  -->		
	                        </div>
	                        <div class="row">
