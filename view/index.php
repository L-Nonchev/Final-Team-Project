                    ...
                    <div class="cb-content">
                        <div class="row">
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[0]['user_id']??''?>">
                            ...
                            <div class="col-lg-2  col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[1]['user_id']??''?>">
                            ...
                            <div class="col-lg-2  col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[2]['user_id']??''?>">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[3]['user_id']??''?>">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[4]['user_id']??''?>">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="ChannelController.php?@$^^%@@^@^$^@=<?=$popularChannels[5]['user_id']??''?>">
