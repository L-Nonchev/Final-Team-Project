                        ...
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li><a href="#" class="color-active">New Videos</a></li>
                                </ul>
                            </div>
                ...
                <div class="content-block head-div">
                    <div class="cb-header">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li><a href="#" class="color-active">Most Viewed</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-2 col-sm-2 col-xs-4">
                                <div class="btn-group pull-right bg-clean">
                ...
                <div class="content-block head-div">
                    <div class="cb-header">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li><a href="#">Popular Channels</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-2 col-sm-2 col-xs-4">
                                <div class="btn-group pull-right bg-clean">
                    ...
                    <div class="cb-content">
                        <div class="row">
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-1.png" alt="">
                            ...
                            <div class="col-lg-2  col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-2.png" alt="">
                            ...
                            <div class="col-lg-2  col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-3.png" alt="">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-4.png" alt="">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-5.png" alt="">
                            ...
                            <div class="col-lg-2 col-sm-4 col-xs-6">
                                <div class="b-chanel">
                                    <a href="#">
                                        <img src="assets/images/chanel-6.png" alt="">
